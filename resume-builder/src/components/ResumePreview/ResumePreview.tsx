...
function ResumePreview({ info, experience }: ResumePreviewProps) {
    console.log('ResumePreview rendered');
    return (
        <div className="col-span-2 shadow-lg border border-gray-200 p-6 rounded-lg bg-white">
            {/* Name */}
            ...
            {/* Contact Info */}
            <div className="flex justify-center flex-wrap text-sm text-gray-600 mb-4 divide-x divide-gray-300">
            ...
            {/*                <div className="flex flex-wrap text-sm text-gray-600 divide-x divide-gray-300">*/}
            ...
            {/*                    )}*/}
            {/*                </div>*/}
            {/*                <div className="flex flex-wrap text-sm font-medium text-gray-800 divide-x divide-gray-300">*/}
